...
if __name__ == "__main__":
   ...
   df_meetingids_two.to_csv('./Production_Service_Grouping/SP'+'/special_services_'+date_time+'.csv', index= False)
   ...
   df_meetingids_three.to_csv('./Production_Service_Grouping/PS'+'/special_services_segments_'+date_time+'.csv', index= False)
   df_meetingids_three = df_meetingids_three.loc[:,'Meeting ID']
   gid = "edit#gid=" + str(res["sheets"][3]["properties"]["sheetId"])
   baseURL = "https://docs.google.com/spreadsheets/d/1xEDsfIFRD6LCjO0hHe543DAyqCyNmlOVo_Q46CLhFVE/"
   fullURL = baseURL + gid
   sheet_url_four = fullURL
   csv_export_url_four = sheet_url_four.replace('/edit#gid=', '/export?format=csv&gid=')
   df_meetingids_four = pd.read_csv(csv_export_url_four)
   df_meetingids_four.to_csv('./Production_Service_Grouping/RSEG'+'/recurring_segments_'+date_time+'.csv', index= False)
   df_meetingids_four = df_meetingids_four.loc[:,'Meeting ID']
   df_meetingids = pd.concat([df_meetingids_one, df_meetingids_two, df_meetingids_three, df_meetingids_four])
   print(df_meetingids_one) 
   print(df_meetingids_two) 
   print(df_meetingids_three) 
   print(df_meetingids_four)
